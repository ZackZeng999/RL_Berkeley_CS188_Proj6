...
class DeepQNetwork(Module):
    ...
    def get_loss(self, states, Q_target):
        ...
        Inputs:
            states: a (batch_size x state_dim) tensor
            Q_target: a (batch_size x num_actions) tensor, or None
        Output:
    ...
    def forward(self, states):
        ...
        Inputs:
            ...
            Q_target: a (batch_size x num_actions) tensor, or None
        Output:
            result: (batch_size x num_actions) tensor of Q-value
        ...
        x = relu(self.fc2(x)) 
        x = relu(self.fc3(x))
        x = self.fc4(x)  # no ReLU on final layer
        return x
